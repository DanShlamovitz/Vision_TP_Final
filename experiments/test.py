...
class XgBoost(nn.Module):
    ...
    def fit(self, X, y, X_val=None, y_val=None, verbose=True, early_stopping_rounds=50):
        ...
        usando early stopping y visualizando la pérdida de entrenamiento y validación.

        Args:
            X: Features para entrenamiento.
            y: Labels correspondientes.
            X_val: Features para validación (opcional).
            y_val: Labels correspondientes para validación (opcional).
            verbose: Booleano para mostrar el progreso del entrenamiento.
            early_stopping_rounds: Número de rondas sin mejora para detener el entrenamiento.
        """
    ...
    def plot_loss_curve(self, results):
        ...
        Args:
            results: Resultados del entrenamiento con XGBoost, que contienen las pérdidas.
        """
    ...
    #         self.xgb.fit(X, y, eval_set=eval_set, verbose=verbose)
    #     else:
    #         self.xgb.fit(X, y, verbose=verbose)
